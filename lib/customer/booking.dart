...
import 'package:pixelpioneer_cpplink/customer/college.dart';
...
class customerBookingState extends State<customerBooking> {
 ...
 Future<void> fetchTrackingIds(String name, String phone) async {
    try {
...
Future<void> addBookingParcel(String name, String phone, String address, String trackingid,int price) async {
  try {
    ...
    QuerySnapshot querySnapshot = await FirebaseFirestore.instance
        ...
        .where('tracking_number', isEqualTo: trackingid)
  ...
  void initState() {
    ...
    if (mounted) 
    {
      FirebaseFirestore.instance
          ...
          .snapshots()
          .listen((snapshot) {
        print('Received Firestore snapshot');
        snapshot.docChanges.forEach((change) {
          if (change.type == DocumentChangeType.added ||
              change.type == DocumentChangeType.modified ||
              change.type == DocumentChangeType.removed) {
            // Handle changes here (e.g., update UI, call updateListParcel())
            print('Change type: ${change.type}, Document ID: ${change.doc.id}');
            updateListParcel(); // Call your method to update parcel list
          }
        });
      });
    }
  ...
  Widget build(BuildContext context) {
    fetchTrackingIds(user_name,user_phone);
    return Scaffold(
      appBar: AppBar(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    user_name + parcelTrackingIds.length.toString(),
