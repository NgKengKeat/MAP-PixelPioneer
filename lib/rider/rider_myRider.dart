...
class RiderRiderPage extends StatefulWidget {
  const RiderRiderPage({super.key});

  @override
  State<RiderRiderPage> createState() => customerBbookingState();
}

class customerBbookingState extends State<RiderRiderPage> {
     ...
     FirebaseFirestore.instance
        ...
        for (var change in snapshot.docChanges) {
          if (change.type == DocumentChangeType.added ||
            ...
            print('Change received: ${change.doc.data()}');
            updateData();
          }
        }
      });
