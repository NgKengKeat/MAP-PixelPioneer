...
class RiderRegisterPage extends StatefulWidget 
{
  ...
  @override
  State<RiderRegisterPage> createState() => _CustomerRegisterPageState();
}

class _CustomerRegisterPageState extends State<RiderRegisterPage> 
{
  ...
  Future<void> _signUp(String _name, String _phone, String _email) async
  {
    if (_formKey.currentState!.validate()) {
      ...
      try 
      {
        ...
        Navigator.of(context).pushReplacementNamed('/rider_vehicle');
