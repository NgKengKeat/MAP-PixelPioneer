...
class _RiderUploadVehicleState extends State<RiderUploadVehicle> {
  ...
  Future<void> uploadVehicle(String id) async 
  {
  ...
  Future<String> signupRider(String vehicleModel, String vehicleColor, String plateNumber, String vehicleType) async {
  try {
    User? user = FirebaseAuth.instance.currentUser;
    if (user != null) {
      CollectionReference riders = FirebaseFirestore.instance.collection('riders');
      
      DocumentReference docRef = await riders.add({
        'userId': user.uid,  
      ...
      print('Rider signed up successfully with ID: ${docRef.id}');
    ...
    print('Failed to sign up rider: $e');
    throw e;
  }
}
...
Future<void> uploadImage(String docId) async {
  try {
    String imageUrl = 'https://example.com/path/to/image.jpg';  // Example image URL
