    ...
    if (_formKey.currentState!.validate()) {
      try {
        ...
        await FirebaseFirestore.instance
            .collection('parcels') // Your collection name
            .doc(_trackingNumber.text) // Use tracking number as document ID
            .update({
...
////////////////////////////////////////////////////////
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: DropdownButton<String>(
                                    value: deliveryStatusController.text.isNotEmpty ? deliveryStatusController.text : null,
                                    onChanged: (String? newValue) {
                                      setState(() {
                                        deliveryStatusController.text = newValue!;
                                      });
                                    },
                                    items: <String>[
                                      'arrived',
          ...
          try {
            ...
            await FirebaseFirestore.instance
                .collection('parcels') // Your collection name
                .doc(tracking_id) // Document ID is the tracking ID
                .delete();

            Fluttertoast.showToast(msg: "The parcel has been deleted!");

            Navigator.pop(context); // Close the dialog
            Navigator.of(context).pop(); // Optionally, navigate back

            // Optionally, refresh parcel list if you have a list view to update
            await getParcelList();
          } catch (e) {
            Fluttertoast.showToast(msg: "Error deleting parcel: $e");
          }
        },
