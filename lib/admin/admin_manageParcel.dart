...
class _AdminManageParcelState extends State<AdminManageParcel> {
  ...
  void initState() {
    super.initState();
    userNameList();
    print('Initial parcel data: $parcel_data');
  if (parcel_data != null && parcel_data.isNotEmpty) {
    parcel_list = List.from(parcel_data); // Make sure parcel_data is not empty
    print('Parcel List initialized: $parcel_list');
  } else {
    print('Parcel data is empty');
  }
  }
                ...
                Padding(
                  ...
                  child: Table(
                    ...
                    children: [
                      ...
                      for (var rowData in parcel_list) //change to user_list to display user
