...
//   // Fetch requested parcels from the Firestore collection
//   QuerySnapshot querySnapshot = await firestore
//       .collection('booking')
//       .where('booking_status', isEqualTo: 'requested') 
//       .get();

//   // Assuming you have a requestedParcelList variable to hold the fetched data
//   requestedParcelList = querySnapshot.docs.map((doc) => doc.data()).toList();

//   // Print fetched requested parcels for debugging
//   print('Fetched requested parcels: $requestedParcelList');
// }
